...
export default function FAQ({ c }: Props) {
  ...
  return (
    <section id="faq" style={{ padding: '120px 48px', background: th.bgAlt }}>
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        <div style={{ marginBottom: 56, textAlign: 'center' }}>
          ...
          <h2 style={{
            fontFamily: th.fontDisplay, fontSize: 56, lineHeight: 1.02,
        ...
        <div>
          {c.faq.items.map((item, i) => (
            <div key={i} style={{ borderTop: `1px solid ${th.border}` }}>
              ...
              >
                <span style={{ fontFamily: th.fontDisplay, fontSize: 22, color: th.ink, letterSpacing: -0.3 }}>
                  {item.q}
                </span>
                <span style={{
              ...
              {open === i && (
                <p style={{
                  fontSize: 16, lineHeight: 1.6, color: th.inkSoft,
