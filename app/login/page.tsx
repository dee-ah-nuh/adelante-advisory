    ...
    <div style={{ minHeight: '100vh', background: th.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <div style={{ fontFamily: th.fontMono, fontSize: 11, color: th.muted, letterSpacing: 1.5, marginTop: 4 }}>SIGN IN</div>
        </div>
        ...
        <form onSubmit={handleLogin} style={{
          ...
          <div style={{ textAlign: 'center', fontSize: 13, color: th.muted }}>
            ...
            <a href="/signup" style={{ color: th.ink, borderBottom: `1px solid ${th.border}` }}>Sign up</a>
          </div>
        </form>
...
const inputStyle: React.CSSProperties = {
  ...
  borderRadius: th.radius, fontSize: 14, color: th.ink,
  fontFamily: th.fontBody, outline: 'none',
};
